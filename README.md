...
1. Building a SAP with logo and 2 links navigating to 2 pages
    (Home and Breweries).
 ...
 2. There is a block with a line "You've clicked <this> 1 time.
      - When user clicks in the "this" button, 
        the number following will be incremented.

 3. As a following line, there is a block containing a textbox and
    a line "You said:" below.
       - When user types any characters or numbers in the textbox,
         the following line will immidiately show out that string of 
         characters or numbers.

  4. Finally, the final block was appeared in grey color in the begining
     including a line "The click counter is not greater than 4" 
     in the center adjustment.
      - When user clicks the "this" button from 1 to 3 times, this grey
        block would not change. It will only change to the yellow color 
        if user clicks more than 3 times in that "this" button.
 
== BREWERIES PAGE ==

  5. There is a list of companies with 4 items in a line.
     Each of list item descripts the company's information in a box
     such as NAME - location in the top and website address in the bottom.
...
STEP 2: ________________________________________________
 ...
 - Modifying the file naming "app.component.html"
  ...
  - Modifying file : "styles.scss"
   ...
   - Create 2 components "HOME" and "BREWERIES".
     for making navigation connecting 2 pages.
   ...
   - Modifying "home.component.scss"
    ...
    - Using "ngIf" + "ngIfElse" for change status 
      ...
      . adding as below:
        --------------------------------------------------------
	<div class="play-container" [style.background-color]= 
                   "clickCounter > 4 ? 'yellow' : 'lightgray'">
 ...
 Step 4: (FINALLY) 
 Building and Running a Webapp product.

 - INSTALL LITE-SERVER
   . Writing a command line: "C:\User\AngularProject> npm i -g lite-server"

 - Running a Webapp
   . Writing a command line: "C:\User\AngularProject> lite-server"
